...
import ReviewUserCard from "../ReviewUserCard/ReviewUserCard";
...
//   review loaded api 
  ...
  return (
    <div>
      <div>
        <div>
          <div className="w-full bg-white rounded-lg shadow-md dark:border-gray-700">
            <Link>
              <PhotoProvider>
                <PhotoView src={image}>
                  <img
            ...
            <div className="px-5 pb-5">
              ...
              <div className="mb-5">
                <p>
                  <span className="font-bold">Cooked Duration :</span>{" "}
                  {cooked_duration} Minute{" "}
                </p>
                <p>
