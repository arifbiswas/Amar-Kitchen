      ...
      <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md ">
        ...
        >
          <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
              ...
              onBlur={(e)=>setService({...service,description:e.target.value})}
                id="passwordConfirmation"
                type="text"
                className="block w-full  py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md    focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring"
              />
            </div>
          ...
          <div className="flex justify-end mt-6">
            <button
            type="submit"
            className="px-8 py-3 w-full leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
              Save
            </button>
          </div>
        </form>
